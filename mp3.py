...
class AutomationGroupWidget(QWidget):
    def __init__(self, group_name, confidence_threshold, automation_templates):
        ...
        self.loot_detected = False  # Loot detection flag
    ...
    def upload_loot_template(self):
        ...
        if file_path:
            ...
            self.loot_list.addItem(f"Loot: {os.path.basename(file_path)}")
    ...
    def upload_mp3_file(self):
        ...
        if file_path:
            ...
            self.loot_list.addItem(f"MP3: {os.path.basename(file_path)}")
            ...
            while self.running:
                ...
                for loot_path in self.loot_templates:
                    if self.find_button(loot_path):
                        ...
                        break  # Notify only once per loop
